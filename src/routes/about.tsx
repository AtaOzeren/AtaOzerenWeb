        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex flex-col items-center mb-12">
            <img
              ...
              alt="Ata Özeren"
              class="w-64 h-64 md:w-72 md:h-72 object-cover rounded-full border-4 border-white/20 shadow-2xl select-none cursor-pointer transition-all duration-300 mb-6"
