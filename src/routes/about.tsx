...
export default function About() {
  ...
  let paragraph1Ref: HTMLParagraphElement;
  let paragraph2Ref: HTMLParagraphElement;
  let paragraph3Ref: HTMLParagraphElement;

  onMount(() => {
    // GSAP animasyonu: Yazılar fade in ve yukarıdan kayarak gelsin
    gsap.fromTo([paragraph1Ref, paragraph2Ref, paragraph3Ref], 
      { 
        opacity: 0, 
        y: 50 
      }, 
