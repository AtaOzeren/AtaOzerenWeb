...
export default function Contact() {
    ...
    return (
        <main class="min-h-screen relative overflow-hidden pt-20">
            ...
            <Meta name="description" content="Contact Ata Özeren for web development inquiries and collaboration opportunities." />
            <Meta property="og:title" content={`${t('contact.title')} - ${t('hero.name')}`} />
            <Meta property="og:description" content="Contact Ata Özeren for web development inquiries and collaboration opportunities." />
            ...
            <div class="relative z-10 container mx-auto px-6 py-12">
                <div class="max-w-5xl mx-auto">
                    ...
                    {/* Hero Section - Profile on left, Title on right */}
                    <div class="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
                        ...
                        <div class="flex flex-col items-center">
                            <img
                                ...
                                alt="Ata Özeren"
                                class="w-48 h-48 md:w-56 md:h-56 object-cover rounded-full border-4 border-white/20 shadow-2xl select-none"
                            />
                        </div>

                        {/* Right - Title and Social */}
                        <div class="text-center md:text-right">
                            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">{t('contact.subtitle')}</h1>

                            {/* Social Media Links */}
                            <div class="flex gap-3 justify-center md:justify-end mb-6">
