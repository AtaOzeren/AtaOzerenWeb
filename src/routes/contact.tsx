        ...
        <main class="min-h-screen relative overflow-hidden pt-20">
            ...
            <div class="relative z-10 container mx-auto px-6 py-12">
                <div class="max-w-5xl mx-auto">
                    ...
                    {/* Hero Section - Title on left, Profile on right */}
                    <div class="flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
                        {/* Left - Title and subtitle */}
                        <div class="text-center md:text-left">
                            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">{t('contact.title')}</h1>
                            <p class="text-lg text-white/60 max-w-md">{t('contact.subtitle')}</p>

                            {/* Location */}
                            <div class="mt-6 inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full">
                        ...
                        <div class="flex flex-col items-center">
                            <img
                                ...
                                alt="Ata Özeren"
                                class="w-48 h-48 md:w-56 md:h-56 object-cover rounded-full border-4 border-white/20 shadow-2xl select-none mb-4"
                            />

                            {/* Social Media Links - under profile */}
